...
public abstract class Connection extends PacketRegistry {
	...
	/**
	 * Will be evaluated when the {@link Connection} has received a {@link Packet}.
	 *
	 * @param packet
	 ...
	 * arguments to the {@link OutputStream} of this {@link Connection} instance.
	 *
	 * @param packet
	...
	/**
	 * Initializes the {@link ListeningThread} with the {@link InputStream} 'in' and
